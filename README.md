...
| [Presentazione](Docs/Presentazione.pdf) | A brief overview of the project that outlines the main phases of the penetration test, the methodology used, the chain of compromise, and the results obtained. |
